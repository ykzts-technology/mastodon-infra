...
module "mastodon-secrets" {
  ...
  redis_hostname                               = module.valkey_cluster.psc_auto_connection.psc_auto_connection[0].ip_address
  redis_port                                   = module.valkey_cluster.psc_auto_connection.psc_auto_connection[0].port
