...
provider "registry.terraform.io/hashicorp/google" {
  version     = "7.22.0"
  constraints = ">= 3.33.0, >= 3.53.0, >= 3.83.0, >= 4.25.0, >= 4.64.0, >= 5.2.0, >= 5.12.0, >= 6.19.0, >= 6.37.0, >= 7.0.0, >= 7.2.0, 7.22.0, < 8.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "7.22.0"
  constraints = ">= 4.64.0, >= 5.12.0, >= 6.19.0, >= 7.0.0, >= 7.2.0, 7.22.0, < 8.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/kubernetes" {
  version     = "3.1.0"
  constraints = ">= 2.10.0, 3.1.0, < 4.0.0"
  hashes = [
